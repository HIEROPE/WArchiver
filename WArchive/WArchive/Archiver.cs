...
namespace WArchive
{
    class Archiver
    {
        ...
        public Archiver()
        {
            ...
            System.Console.WriteLine(ConfigurationManager.AppSettings["file_ext"]);
        ...
        public void archive_files()
        {
            if (string.IsNullOrEmpty(this.to_dir))
            {
                ...
                this.to_dir = this.from_dir + @"\" + this.from_dir.Substring(this.from_dir.IndexOf(@"\") + 1);
            }
            ...
            //System.IO.DirectoryInfo dirInfo = new System.IO.DirectoryInfo(from_dir);
            ...
            foreach (string dir in d)
            {
                ...
                {
                    //this.rar_cmd = @""""+ this.rar_path + @"""" + ' ' + String.Format(rar_cmd, to_dir, '"'+dir, file_ext + '"');
                    //this.rar_cmd = String.Format(rar_cmd, to_dir, '"' + dir, file_ext + '"');
            ...
            ////ifzão da massa
            //this.rar_cmd = this.rar_path + ' ' + String.Format(rar_cmd, to_dir, from_dir, file_ext);
        }
